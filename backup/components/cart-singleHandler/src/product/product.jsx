            ...
            <table className="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td><i onClick={this.updateHandler.bind(this,-1)} className="fa fa-minus-circle"></i>{this.state.product.qty}<i onClick={this.updateHandler.bind(this,+1)} className="fa fa-plus-circle"></i></td>
